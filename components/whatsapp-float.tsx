  ...
  return (
    ...
    >
      <svg viewBox="0 0 24 24" className="w-7 h-7 fill-white">
        ...
        <path d="M12 0C5.373 0 0 5.373 0 12c0 2.128.558 4.122 1.528 5.856L.057 23.882a.5.5 0 0 0 .61.61l6.031-1.469A11.942 11.942 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-1.891 0-3.66-.524-5.17-1.434l-.37-.22-3.83.933.949-3.818-.242-.383A9.956 9.956 0 0 1 2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z"/>
      </svg>
    </a>
  )
}
